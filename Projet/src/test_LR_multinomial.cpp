...
int main(int argc, const char* argv[]){
    ...
    load_labels("../Dataset/train_labels_O_vs_rest.csv", train_labels_O_vs_rest);
    std::vector<int> train_labels_PER_vs_rest; 
    load_labels("../Dataset/train_labels_PER_vs_rest.csv", train_labels_PER_vs_rest);
    std::vector<int> train_labels_MISC_vs_rest;
    load_labels("../Dataset/train_labels_MISC_vs_rest.csv", train_labels_MISC_vs_rest);
    std::vector<int> train_labels_LOC_vs_rest;
    load_labels("../Dataset/train_labels_LOC_vs_rest.csv", train_labels_LOC_vs_rest);
    std::vector<int> train_labels_ORG_vs_rest;
    load_labels("../Dataset/train_labels_ORG_vs_rest.csv", train_labels_ORG_vs_rest);

    //load test labels
    std::vector<int> test_labels_O_vs_rest;
    load_labels("../Dataset/testa_labels_O_vs_rest.csv", test_labels_O_vs_rest);
    std::vector<int> test_labels_PER_vs_rest;
    load_labels("../Dataset/testa_labels_PER_vs_rest.csv", test_labels_PER_vs_rest);
    std::vector<int> test_labels_MISC_vs_rest;
    load_labels("../Dataset/testa_labels_MISC_vs_rest.csv", test_labels_MISC_vs_rest);
    std::vector<int> test_labels_LOC_vs_rest;
    load_labels("../Dataset/testa_labels_LOC_vs_rest.csv", test_labels_LOC_vs_rest);
    std::vector<int> test_labels_ORG_vs_rest;
    load_labels("../Dataset/testa_labels_ORG_vs_rest.csv", test_labels_ORG_vs_rest);
    std::vector<int> test_true_labels;
    load_labels("../Dataset/testa_labels_multinomial.csv", test_true_labels);
